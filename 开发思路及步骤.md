...
![image-20220508105345230](../../../../Typora/Examples/image/image-20220508105345230.png)
...
![image-20220508161505391](../../../../Typora/Examples/image/image-20220508161505391.png)

需要现在homeView中写上`<router-view></router-view>`，然后进而配置路由

![image-20220508161550740](../../../../Typora/Examples/image/image-20220508161550740.png)
...
![image-20220509094317315](../../../../Typora/Examples/image/image-20220509094317315.png)
...
![image-20220510205751842](../../../../Typora/Examples/image/image-20220510205751842.png)

![image-20220510205903460](../../../../Typora/Examples/image/image-20220510205903460.png)
...
![image-20220511151845140](../../../../Typora/Examples/image/image-20220511151845140.png)

![image-20220511151850890](../../../../Typora/Examples/image/image-20220511151850890.png)

另外，因为vue语法编译的特点不要直接在插值语法中使用三元表达式，虽然不会编译失败但是会一直报红，最好使用v-text指令或者把特殊字符进行转义。

![image-20220511174726199](../../../../Typora/Examples/image/image-20220511174726199.png)
...
![image-20220512094022403](../../../../Typora/Examples/image/image-20220512094022403.png)

不知道为什么在任何生命周期钩子中都拿不到事件总线的所抛出来的数据，这个问题困扰我很久

![image-20220512161412225](D:\Typora\Examples\image\image-20220512161412225.png)
...
![image-20220513181609298](../../../../Typora/Examples/image/image-20220513181609298.png)
...
![image-20220514161732039](../../../../Typora/Examples/image/image-20220514161732039.png)
...
![image-20220515174242331](../../../../Typora/Examples/image/image-20220515174242331.png)
...
![image-20220516174719551](../../../../Typora/Examples/image/image-20220516174719551.png)

<font color='orange'>经验总结：如果样式没有生效，大概率是父子层级写错了</font>

路由的params可选参数其中问号要写在最后面：

![image-20220516191112448](../../../../Typora/Examples/image/image-20220516191112448.png)

### 5.17号

主路由下的第一个子路由如何默认显示高亮，可以在父路由上使用`redirect`重定向到第一个子路由

![image-20220517152155822](../../../../Typora/Examples/image/image-20220517152155822.png)

**white-space: pre-line;**属性可以根据数据中的/n属性进行换行操作

`text-indent: 32.4px;`：属性可以对段落进行空两格处理

![image-20220517162142587](../../../../Typora/Examples/image/image-20220517162142587.png)

文本换行并且空两格逻辑。

今天完成了mv相关部分以及歌手具体信息的子路由部分

![image-20220517173531536](../../../../Typora/Examples/image/image-20220517173531536.png)

点击相似歌手其中一个歌手跳转后，歌手简介栏没有更新，是因为当前组件并没有销毁，所以数据不会更新，可以把需要监听的数据放在watch或者beforeUpdate钩子里面

![image-20220517182517087](../../../../Typora/Examples/image/image-20220517182517087.png)
...
![image-20220518112911887](../../../../Typora/Examples/image/image-20220518112911887.png)

v-for循环嵌套v-for循环是个难点

父组件异步钩子和子组件异步钩子，会出现子组件拿不到数据的情况，可以使用watch和vuex解决 ，今天做完了排行榜单的大致内容，明天早上来将笔记完善
